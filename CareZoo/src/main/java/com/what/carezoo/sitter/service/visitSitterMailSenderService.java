...
public class visitSitterMailSenderService {
	...
	// 이메일 난수 만드는 메서드
		...
		// 회원탈퇴 발송 이메일
		public boolean mailSendWithMember(String vs_email,String vs_name, HttpServletRequest request) {
			
			MimeMessage mail = mailSender.createMimeMessage();
			String htmlStr = "<h2>안녕하세요 MS :p 맡겨쥬 입니다!</h2><br><br>" 
					+ "<h3>" + vs_name + "님</h3>" + "<br>부적절한 홈페이지 활동으로 인하여 본 홈페이지에서 <span style='color:red; font-size:15;'>강제탈퇴</span> 되었음을 알려드립니다." 
