...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".roomAddButton").click(function(){
			...
			roomDiv.appned($("<hr>"));
			roomDiv.appned($("<label>방이름</label>     &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;<input type="text" name="phrm_name"><br>"));
	...
	<div>
		<fieldset>
			...
			<td><input type="text" name="ph_contact"><br></td>
					...
					<tr>
						<th>사진</th>
						<td><br><input type="button" id="addItemBtn" class="my_button"
							value="파일추가">
							<div id="example"></div><br></td>
				</table>
				<br>
				<div>
					<div class="imgs_wrap" style="border:1px solid ; padding:20px"></div>
				</div>
				<hr>
				<br>
				<div>
				<div style="font-size:20px" class="roomAddForm">방 추가하기 &nbsp; &nbsp;<input type="button" value="+" class="roomAddButton"></div>
				<br>
				<label>방이름</label>     &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;<input type="text" name="phrm_name"><br>
				<label>소형견 가격</label>   &nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; <input type="text" name="phrm_price">  &nbsp; &nbsp;
				<label>중형견 가격</label> <input type="text" name="phrm_m_price"> &nbsp; &nbsp;
