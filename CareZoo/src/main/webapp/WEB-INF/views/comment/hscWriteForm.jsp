...
// 	});
		...
		var hsr_num = ${hsr.hsr_num}
		var hs_num = ${hsr.hs_num}
		var c_num = ${hsr.c_num}
		
		console.log("hsr_num =="+hsr_num)
		console.log("hs_num =="+hs_num)
		console.log("c_num =="+c_num)
	
	$.ajax({
		url: "${contextPath}/home/homeSitter",
		data : {hs_num : hs_num},
		dataType: "JSON",
		success: function(data) {
			console.log(data);
			$("#hs_name").val(data.hs.hs_name)
		},
		error: function() {
			alert("실패")
		}
...
<body>
	...
	<div class="container">
		<fieldset>
			...
			<form action="${contextPath }/comment/writeHSC" method="post" enctype="multipart/form-data">
				<table class="tab">
					<tr>
						<th>가정시터이름</th>
						<td>
							<input type="text" id="hs_name" readonly="readonly">
						</td>
					</tr>
					<tr>
						<th>별점*</th>
					...
					<tr>
						<th>내용*</th>
						<td>
							<textarea rows="10" cols="50" name="hsc_comment" class="content"></textarea>
						</td>
					</tr>
<!-- 					<tr> -->
...
<!-- 					</tr> -->
					<tr>
						<td>
							<input type="hidden" name="c_num" value="${hsr.c_num}">
							<input type="hidden" name="hsr_num" value="${hsr.hsr_num}">
							<input type="hidden" name="hs_num" value="${hsr.hs_num}">
							<input type="hidden" name="hsc_star" id="hsc_star" value="0"> 
						</td>
					</tr>
					<tr>
