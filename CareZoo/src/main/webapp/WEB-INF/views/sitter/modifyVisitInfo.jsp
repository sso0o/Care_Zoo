...
<div class="container">
	...
	<div class="content">
		...
		<form action="${contextPath }/sitter/modifyVs" method="post" name="userInfo" onsubmit="return checkValue()" enctype="multipart/form-data" >
			<%-- 			<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token}"> --%>
			<input type="hidden" value="<%=session.getAttribute("user_num")%>" name="vs_num">
			<div class="main">
				<div class="form-group">
					<label for="email">아이디</label>
					<input type="email" class="form-control" id="email" name="vs_email" readonly="readonly">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" placeholder="이름을 입력해 주세요" name="vs_name" readonly="readonly">
				</div>
				<div class="form-group">
					<label for="birth">생년월일</label>
					<input type="date" class="form-control" id="birth" name="vs_birth" readonly="readonly">
				</div>
				<div class="form-group">
					<label for="sex">성별</label>
					<input type="text" class="form-control" id="sex" readonly="readonly">
					<input type="hidden" class="form-control" id="c_sex" name="vs_sex" readonly="readonly">
				</div>
