...
<button onclick="location.href='${contextPath}/visit/apply'">정기 방문 돌봄 신청</button><br>
<button onclick="location.href='${contextPath}/visit/apply'">일반 방문 돌봄 신청</button><br>
<br>
<h3><img src="${contextPath}/resources/img/schedule.jpg">
<a href="${contextPath}/visit/apply">정기 방문 돌봄 신청</a></h3><br>
<p>매월 몇 회씩 방문 돌봄을 신청하는 서비스로 
정기 결제 시 최대 22% 할인된 가격으로 이용하실 수 있습니다.</p><br>
<h3><img src="${contextPath}/resources/img/check.jpg">
<a href="${contextPath}/visit/apply">일반 방문 돌봄 신청</a></h3><br>
